 ...
 */
package CIMSTEST.Financial.ClaimStatus;
...
public class Value extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
  private static final long serialVersionUID = 2257595476933865368L;
  public static final org.apache.avro.Schema SCHEMA$ = new org.apache.avro.Schema.Parser().parse("{\"type\":\"record\",\"name\":\"Value\",\"namespace\":\"CIMSTEST.Financial.ClaimStatus\",\"fields\":[{\"name\":\"CS_ClaimStatusID\",\"type\":\"int\"},{\"name\":\"CS_Description\",\"type\":[\"null\",\"string\"],\"default\":null}],\"connect.name\":\"CIMSTEST.Financial.ClaimStatus.Value\"}");
   ...
   */
  public Value(java.lang.Integer CS_ClaimStatusID, java.lang.CharSequence CS_Description) {
   ...
   */
  public static CIMSTEST.Financial.ClaimStatus.Value.Builder newBuilder() {
    return new CIMSTEST.Financial.ClaimStatus.Value.Builder();
  }
   ...
   * @return A new Value RecordBuilder
   */
  public static CIMSTEST.Financial.ClaimStatus.Value.Builder newBuilder(CIMSTEST.Financial.ClaimStatus.Value.Builder other) {
    return new CIMSTEST.Financial.ClaimStatus.Value.Builder(other);
  }
   ...
   * @return A new Value RecordBuilder
   */
  public static CIMSTEST.Financial.ClaimStatus.Value.Builder newBuilder(CIMSTEST.Financial.ClaimStatus.Value other) {
    return new CIMSTEST.Financial.ClaimStatus.Value.Builder(other);
  }
  ...
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<Value>
     ...
     * @param other The existing Builder to copy.
     */
    private Builder(CIMSTEST.Financial.ClaimStatus.Value.Builder other) {
      super(other);
     ...
     * @param other The existing instance to copy.
     */
    private Builder(CIMSTEST.Financial.ClaimStatus.Value other) {
            super(SCHEMA$);
      if (isValidValue(fields()[0], other.CS_ClaimStatusID)) {
        this.CS_ClaimStatusID = data().deepCopy(fields()[0].schema(), other.CS_ClaimStatusID);
        fieldSetFlags()[0] = true;
    ...
    /**
      ...
      * @return This builder.
      */
    public CIMSTEST.Financial.ClaimStatus.Value.Builder setCSClaimStatusID(int value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public CIMSTEST.Financial.ClaimStatus.Value.Builder clearCSClaimStatusID() {
    ...
    /**
      ...
      * @return This builder.
      */
    public CIMSTEST.Financial.ClaimStatus.Value.Builder setCSDescription(java.lang.CharSequence value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public CIMSTEST.Financial.ClaimStatus.Value.Builder clearCSDescription() {
      CS_Description = null;
